...
router.post("/operator/send-broadcast-email", alumniController.sendBroadcastEmail);
...
//@access          Public
router.get("/operator/alumni/tracer-study/done", alumniController.getAlumniHasTracerStudyByOperator);
